...
/*******************************************************************************
* Function Name: DGB_UART_UartCyBtldrCommStart
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: DGB_UART_UartCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: DGB_UART_UartCyBtldrCommReset
****************************************************************************//**
*
...
void DGB_UART_UartCyBtldrCommReset(void)
{
    ...
    DGB_UART_SpiUartClearRxBuffer();
    DGB_UART_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: DGB_UART_UartCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != DGB_UART_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = DGB_UART_SpiUartGetRxBufferSize();
                    CyDelayUs(DGB_UART_UART_BYTE_TO_BYTE);
                }
                while (byteCount != DGB_UART_SpiUartGetRxBufferSize());

                byteCount = DGB_UART_BYTES_TO_COPY(byteCount, size);
        ...
        {
            pData[i] = (uint8) DGB_UART_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: DGB_UART_UartCyBtldrCommWrite
****************************************************************************//**
*
...
cystatus DGB_UART_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        DGB_UART_SpiUartPutArray(pData, (uint32) size);
