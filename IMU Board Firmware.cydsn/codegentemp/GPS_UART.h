...
#define GPS_UART_CY_SCBIP_V2    (CYIPBLOCK_m0s8scb_VERSION >= 2u)

/** Component version major.minor */
#define GPS_UART_COMP_VERSION_MAJOR    (4)
#define GPS_UART_COMP_VERSION_MINOR    (0)
...
#define GPS_UART_REMOVE_SCB_IRQ             (0u)
...
#define GPS_UART_REMOVE_SCB_CLK     (1u)
#define GPS_UART_SCB_CLK_INTERNAL   (0u == GPS_UART_REMOVE_SCB_CLK)
...
#if (GPS_UART_SCB_CLK_INTERNAL)
    #include "GPS_UART_SCBCLK.h"
#endif /* (GPS_UART_SCB_CLK_INTERNAL) */
...
*/
    ...
    void GPS_UART_SetCustomInterruptHandler(void (*func)(void));
...
/* Interface to internal interrupt component */
    ...
    */    
    /*******************************************************************************
    * Function Name: GPS_UART_EnableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: GPS_UART_DisableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/    
    ...
    /*******************************************************************************
    * Function Name: GPS_UART_ClearPendingInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: GPS_UART_RxWakeEnableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/    
    ...
    /*******************************************************************************
    * Function Name: GPS_UART_RxWakeDisableInt
    ****************************************************************************//**
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: GPS_UART_RxWakeClearPendingInt
    ****************************************************************************//**
    *
...
/* Get interrupt cause */
/*******************************************************************************
* Function Name: GPS_UART_GetInterruptCause
****************************************************************************//**
*
...
*    - GPS_UART_INTR_CAUSE_MASTER - Interrupt from Master
*    - GPS_UART_INTR_CAUSE_SLAVE - Interrupt from Slave
*    - GPS_UART_INTR_CAUSE_TX - Interrupt from TX
*    - GPS_UART_INTR_CAUSE_RX - Interrupt from RX
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: GPS_UART_GetRxInterruptSource
****************************************************************************//**
*
...
*   - GPS_UART_INTR_RX_FIFO_LEVEL - The number of data elements in the 
      RX FIFO is greater than the value of RX FIFO level.
*   - GPS_UART_INTR_RX_NOT_EMPTY - Receiver FIFO is not empty.
*   - GPS_UART_INTR_RX_FULL - Receiver FIFO is full.
*   - GPS_UART_INTR_RX_OVERFLOW - Attempt to write to a full 
*     receiver FIFO.
*   - GPS_UART_INTR_RX_UNDERFLOW - Attempt to read from an empty 
*     receiver FIFO.
*   - GPS_UART_INTR_RX_FRAME_ERROR - UART framing error detected.
*   - GPS_UART_INTR_RX_PARITY_ERROR - UART parity error detected.
*
*******************************************************************************/
...
*   GPS_UART_GetRxInterruptSource() function for bit fields values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: GPS_UART_GetRxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GPS_UART_GetRxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GPS_UART_ClearRxInterruptSource
****************************************************************************//**
*
...
*   - GPS_UART_INTR_RX_FIFO_LEVEL Interrupt source is not cleared when 
*     the receiver FIFO has more entries than level.
*   - GPS_UART_INTR_RX_NOT_EMPTY Interrupt source is not cleared when
*     receiver FIFO is not empty.
*   - GPS_UART_INTR_RX_FULL Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: GPS_UART_SetRxInterrupt
****************************************************************************//**
*
...
*   register (refer to GPS_UART_GetRxInterruptSource() function for bit 
*   fields values).
*
*******************************************************************************/
#define GPS_UART_SetRxInterrupt(interruptMask)  GPS_UART_SET_INTR_RX(interruptMask)

void GPS_UART_SetRxFifoLevel(uint32 level);


/* APIs to service INTR_TX register */
/*******************************************************************************
* Function Name: GPS_UART_GetTxInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - GPS_UART_INTR_TX_FIFO_LEVEL - The number of data elements in the 
*     TX FIFO is less than the value of TX FIFO level.
*   - GPS_UART_INTR_TX_NOT_FULL - Transmitter FIFO is not full.
*   - GPS_UART_INTR_TX_EMPTY - Transmitter FIFO is empty.
*   - GPS_UART_INTR_TX_OVERFLOW - Attempt to write to a full 
*     transmitter FIFO.
*   - GPS_UART_INTR_TX_UNDERFLOW - Attempt to read from an empty 
*     transmitter FIFO.
*   - GPS_UART_INTR_TX_UART_NACK - UART received a NACK in SmartCard 
*   mode.
*   - GPS_UART_INTR_TX_UART_DONE - UART transfer is complete. 
*     All data elements from the TX FIFO are sent.
*   - GPS_UART_INTR_TX_UART_ARB_LOST - Value on the TX line of the UART
...
*   GPS_UART_GetTxInterruptSource() function for bit field values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: GPS_UART_GetTxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GPS_UART_GetTxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GPS_UART_ClearTxInterruptSource
****************************************************************************//**
*
...
*   - GPS_UART_INTR_TX_FIFO_LEVEL - Interrupt source is not cleared when 
*     transmitter FIFO has less entries than level.
*   - GPS_UART_INTR_TX_NOT_FULL - Interrupt source is not cleared when
*     transmitter FIFO has empty entries.
*   - GPS_UART_INTR_TX_EMPTY - Interrupt source is not cleared when 
*     transmitter FIFO is empty.
*   - GPS_UART_INTR_TX_UNDERFLOW - Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: GPS_UART_SetTxInterrupt
****************************************************************************//**
*
*  Sets RX interrupt sources in the interrupt request register.
*
...
void GPS_UART_SetTxFifoLevel(uint32 level);


/* APIs to service INTR_MASTER register */
/*******************************************************************************
* Function Name: GPS_UART_GetMasterInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - GPS_UART_INTR_MASTER_SPI_DONE - SPI master transfer is complete.
*     Refer to Interrupt sources section for detailed description.
*   - GPS_UART_INTR_MASTER_I2C_ARB_LOST - I2C master lost arbitration.
*   - GPS_UART_INTR_MASTER_I2C_NACK - I2C master received negative 
*    acknowledgement (NAK).
*   - GPS_UART_INTR_MASTER_I2C_ACK - I2C master received acknowledgement.
*   - GPS_UART_INTR_MASTER_I2C_STOP - I2C master generated STOP.
*   - GPS_UART_INTR_MASTER_I2C_BUS_ERROR - I2C master bus error 
...
/*******************************************************************************
* Function Name: GPS_UART_SetMasterInterruptMode
****************************************************************************//**
*
...
*   GPS_UART_GetMasterInterruptSource() function for bit field values).
*
*******************************************************************************/
#define GPS_UART_SetMasterInterruptMode(interruptMask)  GPS_UART_WRITE_INTR_MASTER_MASK(interruptMask)

/*******************************************************************************
* Function Name: GPS_UART_GetMasterInterruptMode
****************************************************************************//**
*
...
*   GPS_UART_GetMasterInterruptSource() function for return values).
*
*******************************************************************************/
#define GPS_UART_GetMasterInterruptMode()   (GPS_UART_INTR_MASTER_MASK_REG)

/*******************************************************************************
* Function Name: GPS_UART_GetMasterInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GPS_UART_ClearMasterInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GPS_UART_SetMasterInterrupt
****************************************************************************//**
*
*  Sets Master interrupt sources in the interrupt request register.
*
*  \param interruptMask: Master interrupt sources to set in the Master interrupt
*   request register (refer to GPS_UART_GetMasterInterruptSource() 
...
/*******************************************************************************
* Function Name: GPS_UART_GetSlaveInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - GPS_UART_INTR_SLAVE_I2C_ARB_LOST - I2C slave lost arbitration: 
*     the value driven on the SDA line is not the same as the value observed 
*     on the SDA line.
*   - GPS_UART_INTR_SLAVE_I2C_NACK - I2C slave received negative 
*     acknowledgement (NAK).
*   - GPS_UART_INTR_SLAVE_I2C_ACK - I2C slave received 
*     acknowledgement (ACK).
*   - GPS_UART_INTR_SLAVE_I2C_WRITE_STOP - Stop or Repeated Start 
*     event for write transfer intended for this slave (address matching 
*     is performed).
*   - GPS_UART_INTR_SLAVE_I2C_STOP - Stop or Repeated Start event 
*     for (read or write) transfer intended for this slave (address matching 
*     is performed).
*   - GPS_UART_INTR_SLAVE_I2C_START - I2C slave received Start 
*     condition.
*   - GPS_UART_INTR_SLAVE_I2C_ADDR_MATCH - I2C slave received matching 
*     address.
*   - GPS_UART_INTR_SLAVE_I2C_GENERAL - I2C Slave received general 
*     call address.
*   - GPS_UART_INTR_SLAVE_I2C_BUS_ERROR - I2C slave bus error (detection 
*      of unexpected Start or Stop condition).
*   - GPS_UART_INTR_SLAVE_SPI_BUS_ERROR - SPI slave select line is 
...
/*******************************************************************************
* Function Name: GPS_UART_SetSlaveInterruptMode
****************************************************************************//**
*
...
*   GPS_UART_GetSlaveInterruptSource() function for bit field values).
*
*******************************************************************************/
#define GPS_UART_SetSlaveInterruptMode(interruptMask)   GPS_UART_WRITE_INTR_SLAVE_MASK(interruptMask)

/*******************************************************************************
* Function Name: GPS_UART_GetSlaveInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GPS_UART_GetSlaveInterruptSourceMasked
****************************************************************************//**
*
...
*   GPS_UART_GetSlaveInterruptSource() function for return values).
*
*******************************************************************************/
#define GPS_UART_GetSlaveInterruptSourceMasked()    (GPS_UART_INTR_SLAVE_MASKED_REG)

/*******************************************************************************
* Function Name: GPS_UART_ClearSlaveInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: GPS_UART_SetSlaveInterrupt
****************************************************************************//**
*
*  Sets Slave interrupt sources in the interrupt request register.
*
*  \param interruptMask: Slave interrupt sources to set in the Slave interrupt 
*   request register (refer to GPS_UART_GetSlaveInterruptSource() 
...
/** GPS_UART_initVar indicates whether the GPS_UART 
*  component has been initialized. The variable is initialized to 0 
*  and set to 1 the first time SCB_Start() is called. This allows 
*  the component to restart without reinitialization after the first 
*  call to the GPS_UART_Start() routine.
*
*  If re-initialization of the component is required, then the 
*  GPS_UART_Init() function can be called before the 
*  GPS_UART_Start() or GPS_UART_Enable() function.
*/
...
#define GPS_UART_STATUS_PTR             ( (reg32 *) GPS_UART_SCB__STATUS)
    ...
    #define GPS_UART_UART_TX_CTRL_PTR       ( (reg32 *) GPS_UART_SCB__UART_TX_CTRL)
    ...
    #define GPS_UART_UART_FLOW_CTRL_REG     (*(reg32 *) GPS_UART_SCB__UART_FLOW_CTRL)
    #define GPS_UART_UART_FLOW_CTRL_PTR     ( (reg32 *) GPS_UART_SCB__UART_FLOW_CTRL)
...
#ifdef GPS_UART_SCB__EZ_DATA0
    #define GPS_UART_EZBUF_DATA0_REG    (*(reg32 *) GPS_UART_SCB__EZ_DATA0)
    #define GPS_UART_EZBUF_DATA0_PTR    ( (reg32 *) GPS_UART_SCB__EZ_DATA0)
#else
    #define GPS_UART_EZBUF_DATA0_REG    (*(reg32 *) GPS_UART_SCB__EZ_DATA00)
    #define GPS_UART_EZBUF_DATA0_PTR    ( (reg32 *) GPS_UART_SCB__EZ_DATA00)
#endif /* GPS_UART_SCB__EZ_DATA00 */
...
#define GPS_UART_FIFO_SIZE      (8u)  /* TX or RX FIFO size. */
#define GPS_UART_EZ_DATA_NR     (32u)  /* Number of words in EZ memory. */ 
#define GPS_UART_ONE_BYTE_WIDTH (8u)            /* Number of bits in one byte. */
#define GPS_UART_FF_DATA_NR_LOG2_MASK       (0x0Fu)      /* Number of bits to represent a FIFO address. */
#define GPS_UART_FF_DATA_NR_LOG2_PLUS1_MASK (0x1Fu) /* Number of bits to represent #bytes in FIFO. */
...
#if !(GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1)
    #define GPS_UART_CTRL_BYTE_MODE_POS (11u) /* [11]    Determines the number of bits per FIFO data element */
#endif /* !(GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1) */
#define GPS_UART_CTRL_ADDR_ACCEPT_POS   (16u) /* [16]    Put matched address in RX FIFO       */
#define GPS_UART_CTRL_BLOCK_POS         (17u) /* [17]    Ext and Int logic to resolve collide */
...
#if !(GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1)
    #define GPS_UART_CTRL_BYTE_MODE ((uint32) 0x01u << GPS_UART_CTRL_BYTE_MODE_POS)
#endif /* !(GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1) */
...
/* GPS_UART_STATUS_REG */
#define GPS_UART_STATUS_EC_BUSY_POS     (0u)  /* [0] Bus busy. Externally clocked logic access to EZ memory */
...
#if !(GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1)
    #define GPS_UART_SPI_CTRL_SCLK_CONTINUOUS_POS   (5u)  /* [5]     Enable continuous SCLK generation */
    #define GPS_UART_SPI_CTRL_SSEL0_POLARITY_POS    (8u)  /* [8]     SS0 polarity                      */
    #define GPS_UART_SPI_CTRL_SSEL1_POLARITY_POS    (9u)  /* [9]     SS1 polarity                      */
    #define GPS_UART_SPI_CTRL_SSEL2_POLARITY_POS    (10u) /* [10]    SS2 polarity                      */
    #define GPS_UART_SPI_CTRL_SSEL3_POLARITY_POS    (11u) /* [11]    SS3 polarity                      */
#endif /* !(GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1) */
#define GPS_UART_SPI_CTRL_LOOPBACK_POS          (16u) /* [16]    Local loop-back control enabled            */
...
#if !(GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1)
    #define GPS_UART_SPI_CTRL_SCLK_CONTINUOUS  ((uint32) 0x01u << GPS_UART_SPI_CTRL_SCLK_CONTINUOUS_POS)
    #define GPS_UART_SPI_CTRL_SSEL0_POLARITY   ((uint32) 0x01u << GPS_UART_SPI_CTRL_SSEL0_POLARITY_POS)
    #define GPS_UART_SPI_CTRL_SSEL1_POLARITY   ((uint32) 0x01u << GPS_UART_SPI_CTRL_SSEL1_POLARITY_POS)
    #define GPS_UART_SPI_CTRL_SSEL2_POLARITY   ((uint32) 0x01u << GPS_UART_SPI_CTRL_SSEL2_POLARITY_POS)
    #define GPS_UART_SPI_CTRL_SSEL3_POLARITY   ((uint32) 0x01u << GPS_UART_SPI_CTRL_SSEL3_POLARITY_POS)
    #define GPS_UART_SPI_CTRL_SSEL_POLARITY_MASK ((uint32)0x0Fu << GPS_UART_SPI_CTRL_SSEL0_POLARITY_POS)
#endif /* !(GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1) */
...
/* GPS_UART_UART_CTRL */
#define GPS_UART_UART_CTRL_LOOPBACK_POS         (16u) /* [16] Loop-back    */
...
#define GPS_UART_UART_RX_CTRL_STOP_BITS_POS             (0u)  /* [2:0] Stop bits: (Stop bits + 1) * 0.5 period*/
...
#define GPS_UART_UART_RX_CTRL_LIN_MODE_POS              (12u) /* [12]  Lin mode: applicable for UART Standard */
#define GPS_UART_UART_RX_CTRL_SKIP_START_POS            (13u) /* [13]  Skip start not: only for UART Standard */
...
#define GPS_UART_UART_RX_STATUS_BR_COUNTER_POS     (0u)  /* [11:0] Baud Rate counter */
#define GPS_UART_UART_RX_STATUS_BR_COUNTER_MASK    ((uint32) 0xFFFu)

#if !(GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1)
    /* GPS_UART_UART_FLOW_CTRL_REG */
    #define GPS_UART_UART_FLOW_CTRL_TRIGGER_LEVEL_POS    (0u)  /* [7:0] RTS RX FIFO trigger level         */
    #define GPS_UART_UART_FLOW_CTRL_RTS_POLARITY_POS     (16u) /* [16]  Polarity of the RTS output signal */
    #define GPS_UART_UART_FLOW_CTRL_CTS_POLARITY_POS     (24u) /* [24]  Polarity of the CTS input signal  */
    #define GPS_UART_UART_FLOW_CTRL_CTS_ENABLED_POS      (25u) /* [25]  Enable CTS signal                 */
    #define GPS_UART_UART_FLOW_CTRL_TRIGGER_LEVEL_MASK   ((uint32) GPS_UART_FF_DATA_NR_LOG2_MASK)
    #define GPS_UART_UART_FLOW_CTRL_RTS_POLARITY         ((uint32) 0x01u << \
                                                                       GPS_UART_UART_FLOW_CTRL_RTS_POLARITY_POS)
    #define GPS_UART_UART_FLOW_CTRL_CTS_POLARITY         ((uint32) 0x01u << \
                                                                       GPS_UART_UART_FLOW_CTRL_CTS_POLARITY_POS)
    #define GPS_UART_UART_FLOW_CTRL_CTS_ENABLE           ((uint32) 0x01u << \
                                                                       GPS_UART_UART_FLOW_CTRL_CTS_ENABLED_POS)
#endif /* !(GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1) */

/* GPS_UART_I2C_CTRL */
#define GPS_UART_I2C_CTRL_HIGH_PHASE_OVS_POS           (0u)   /* [3:0] Oversampling factor high: master only */
#define GPS_UART_I2C_CTRL_LOW_PHASE_OVS_POS            (4u)   /* [7:4] Oversampling factor low:  master only */
#define GPS_UART_I2C_CTRL_M_READY_DATA_ACK_POS         (8u)   /* [8]   Master ACKs data while RX FIFO != FULL*/
...
#define GPS_UART_I2C_CTRL_LOOPBACK_POS                 (16u)  /* [16]  Loop-back                             */
...
#define GPS_UART_I2C_CFG_SDA_FILT_OUT_HS_POS        (26u) /* [26]    '0': 50 ns filter, '1': 10 ns filter     */
#define GPS_UART_I2C_CFG_SDA_FILT_OUT_ENABLED_POS   (27u) /* [27]    I2C SDA output delay filter enabled      */
#define GPS_UART_I2C_CFG_SDA_FILT_HYS_MASK          ((uint32) 0x03u)
...
#else
#define GPS_UART_I2C_CFG_SDA_IN_FILT_TRIM_POS   (0u)  /* [1:0] Trim bits for "i2c_sda_in" 50 ns filter */
#define GPS_UART_I2C_CFG_SDA_IN_FILT_SEL_POS    (4u)  /* [4]   "i2c_sda_in" filter delay: 0 ns and 50 ns */
#define GPS_UART_I2C_CFG_SCL_IN_FILT_TRIM_POS   (8u)  /* [9:8] Trim bits for "i2c_scl_in" 50 ns filter */
#define GPS_UART_I2C_CFG_SCL_IN_FILT_SEL_POS    (12u) /* [12]  "i2c_scl_in" filter delay: 0 ns and 50 ns */
#define GPS_UART_I2C_CFG_SDA_OUT_FILT0_TRIM_POS (16u) /* [17:16] Trim bits for "i2c_sda_out" 50 ns filter 0 */
#define GPS_UART_I2C_CFG_SDA_OUT_FILT1_TRIM_POS (18u) /* [19:18] Trim bits for "i2c_sda_out" 50 ns filter 1 */
#define GPS_UART_I2C_CFG_SDA_OUT_FILT2_TRIM_POS (20u) /* [21:20] Trim bits for "i2c_sda_out" 50 ns filter 2 */
#define GPS_UART_I2C_CFG_SDA_OUT_FILT_SEL_POS   (28u) /* [29:28] Cumulative "i2c_sda_out" filter delay: */

#define GPS_UART_I2C_CFG_SDA_IN_FILT_TRIM_MASK  ((uint32) 0x03u)
#define GPS_UART_I2C_CFG_SDA_IN_FILT_SEL        ((uint32) 0x01u << GPS_UART_I2C_CFG_SDA_IN_FILT_SEL_POS)
#define GPS_UART_I2C_CFG_SCL_IN_FILT_TRIM_MASK  ((uint32) 0x03u << \
                                                            GPS_UART_I2C_CFG_SCL_IN_FILT_TRIM_POS)
#define GPS_UART_I2C_CFG_SCL_IN_FILT_SEL        ((uint32) 0x01u << GPS_UART_I2C_CFG_SCL_IN_FILT_SEL_POS)
#define GPS_UART_I2C_CFG_SDA_OUT_FILT0_TRIM_MASK ((uint32) 0x03u << \
                                                            GPS_UART_I2C_CFG_SDA_OUT_FILT0_TRIM_POS)
#define GPS_UART_I2C_CFG_SDA_OUT_FILT1_TRIM_MASK ((uint32) 0x03u << \
                                                            GPS_UART_I2C_CFG_SDA_OUT_FILT1_TRIM_POS)
#define GPS_UART_I2C_CFG_SDA_OUT_FILT2_TRIM_MASK ((uint32) 0x03u << \
                                                            GPS_UART_I2C_CFG_SDA_OUT_FILT2_TRIM_POS)
#define GPS_UART_I2C_CFG_SDA_OUT_FILT_SEL_MASK   ((uint32) 0x03u << \
                                                            GPS_UART_I2C_CFG_SDA_OUT_FILT_SEL_POS)
#endif /* (GPS_UART_CY_SCBIP_V0) */


/* GPS_UART_TX_CTRL_REG */
#define GPS_UART_TX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Data frame width: (Data width - 1) */
...
#define GPS_UART_TX_FIFO_CTRL_CLEAR_POS             (16u) /* [16]  Clear TX FIFO: cleared after set           */
#define GPS_UART_TX_FIFO_CTRL_FREEZE_POS            (17u) /* [17]  Freeze TX FIFO: HW do not inc read pointer */
#define GPS_UART_TX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) GPS_UART_FF_DATA_NR_LOG2_MASK)
...
#define GPS_UART_TX_FIFO_STATUS_USED_MASK   ((uint32) GPS_UART_FF_DATA_NR_LOG2_PLUS1_MASK)
#define GPS_UART_TX_FIFO_SR_VALID           ((uint32) 0x01u << GPS_UART_TX_FIFO_SR_VALID_POS)
#define GPS_UART_TX_FIFO_STATUS_RD_PTR_MASK ((uint32) GPS_UART_FF_DATA_NR_LOG2_MASK << \
                                                                    GPS_UART_TX_FIFO_STATUS_RD_PTR_POS)
#define GPS_UART_TX_FIFO_STATUS_WR_PTR_MASK ((uint32) GPS_UART_FF_DATA_NR_LOG2_MASK << \
                                                                    GPS_UART_TX_FIFO_STATUS_WR_PTR_POS)
...
#define GPS_UART_RX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Data frame width: (Data width - 1) */
...
#define GPS_UART_RX_FIFO_CTRL_CLEAR_POS             (16u)  /* [16]  Clear RX FIFO: clear after set           */
#define GPS_UART_RX_FIFO_CTRL_FREEZE_POS            (17u)  /* [17]  Freeze RX FIFO: HW writes has not effect */
#define GPS_UART_RX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) GPS_UART_FF_DATA_NR_LOG2_MASK)
...
#define GPS_UART_RX_FIFO_STATUS_USED_MASK   ((uint32) GPS_UART_FF_DATA_NR_LOG2_PLUS1_MASK)
#define GPS_UART_RX_FIFO_SR_VALID           ((uint32) 0x01u << GPS_UART_RX_FIFO_SR_VALID_POS)
#define GPS_UART_RX_FIFO_STATUS_RD_PTR_MASK ((uint32) GPS_UART_FF_DATA_NR_LOG2_MASK << \
                                                                    GPS_UART_RX_FIFO_STATUS_RD_PTR_POS)
#define GPS_UART_RX_FIFO_STATUS_WR_PTR_MASK ((uint32) GPS_UART_FF_DATA_NR_LOG2_MASK << \
                                                                    GPS_UART_RX_FIFO_STATUS_WR_PTR_POS)
...
#define GPS_UART_INTR_MASTER_SPI_DONE_POS       (9u)  /* [9] Master complete transfer: Only for SPI           */
...
#define GPS_UART_INTR_SLAVE_I2C_STOP_POS             (4u)  /* [4]  Slave detects end of transaction intended */
...
#define GPS_UART_INTR_SLAVE_SPI_EZBUF_STOP_POS       (10u) /* [10] Slave end of transaction: Only for SPI   */
...
#define GPS_UART_INTR_TX_FIFO_LEVEL         (GPS_UART_INTR_TX_TRIGGER)
...
#define GPS_UART_INTR_RX_BAUD_DETECT_POS    (10u)  /* [10] LIN baud rate detection is completed   */
...
#define GPS_UART_INTR_RX_FIFO_LEVEL         (GPS_UART_INTR_RX_TRIGGER)
...
*/
#define GPS_UART_SCB_SW_RESET   GPS_UART_I2CFwBlockReset()
...
/* Return true if sourceMask is set in GPS_UART_CTRL_REG: generally is used to check enable bit */
...
#define GPS_UART_DISABLE_AUTO_DATA \
                do{                        \
                    GPS_UART_I2C_CTRL_REG &= ((uint32) ~(GPS_UART_I2C_CTRL_M_READY_DATA_ACK      |  \
                                                                 GPS_UART_I2C_CTRL_M_NOT_READY_DATA_NACK |  \
                                                                 GPS_UART_I2C_CTRL_S_READY_DATA_ACK      |  \
                                                                 GPS_UART_I2C_CTRL_S_NOT_READY_DATA_NACK)); \
                }while(0)
...
#define GPS_UART_I2C_SLAVE_GENERATE_ACK \
    ...
    void GPS_UART_I2CSlaveNackGeneration(void);
    #define GPS_UART_I2C_SLAVE_GENERATE_NACK GPS_UART_I2CSlaveNackGeneration()
...
#define GPS_UART_DIGITAL_FILTER_DISABLE    (0u)
#define GPS_UART_DIGITAL_FILTER_ENABLE     (1u)
#define GPS_UART_I2C_DATA_RATE_FS_MODE_MAX (400u)
#if (GPS_UART_CY_SCBIP_V0)
    /* GPS_UART_I2C_CFG_SDA_FILT_OUT_ENABLED is disabled by default */
    #define GPS_UART_I2C_CFG_FILT_MASK  (GPS_UART_I2C_CFG_SDA_FILT_ENABLED | \
                                                 GPS_UART_I2C_CFG_SCL_FILT_ENABLED)
#else
    /* GPS_UART_I2C_CFG_SDA_OUT_FILT_SEL_MASK is disabled by default */
    #define GPS_UART_I2C_CFG_FILT_MASK  (GPS_UART_I2C_CFG_SDA_IN_FILT_SEL | \
                                                 GPS_UART_I2C_CFG_SCL_IN_FILT_SEL)
#endif /* (GPS_UART_CY_SCBIP_V0) */

#define GPS_UART_I2C_CFG_ANALOG_FITER_DISABLE \
        do{                                           \
            GPS_UART_I2C_CFG_REG &= (uint32) ~GPS_UART_I2C_CFG_FILT_MASK; \
        }while(0)

#define GPS_UART_I2C_CFG_ANALOG_FITER_ENABLE \
        do{                                          \
            GPS_UART_I2C_CFG_REG |= (uint32)  GPS_UART_I2C_CFG_FILT_MASK; \
        }while(0)
...
/* Return FIFO size depends on GPS_UART_CTRL_BYTE_MODE bit */
#define GPS_UART_GET_FIFO_SIZE(condition) ((0u != (condition)) ? \
                                                    (2u * GPS_UART_FIFO_SIZE) : (GPS_UART_FIFO_SIZE))
...
#if (GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1)
    #define GPS_UART_GET_CTRL_BYTE_MODE(mode)   (0u)
#else
    #define GPS_UART_GET_CTRL_BYTE_MODE(mode)   ((0u != (mode)) ? \
                                                            (GPS_UART_CTRL_BYTE_MODE) : (0u))
#endif /* (GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1) */
...
#define GPS_UART_GET_I2C_CTRL_LOW_PHASE_OVS(oversampleLow)  ((((uint32) (oversampleLow) - 1u) << \
                                                                    GPS_UART_I2C_CTRL_LOW_PHASE_OVS_POS) &  \
...
#define GPS_UART_GET_I2C_CTRL_S_GENERAL_IGNORE(genCall) ((0u != (genCall)) ? \
                                                                    (GPS_UART_I2C_CTRL_S_GENERAL_IGNORE) : (0u))

#define GPS_UART_GET_I2C_CTRL_SL_MSTR_MODE(mode)    ((uint32)(mode) << GPS_UART_I2C_CTRL_SLAVE_MODE_POS)
...
#define GPS_UART_GET_SPI_CTRL_SCLK_MODE(mode)       (((uint32) (mode) << \
...
#if (GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1)
    #define GPS_UART_GET_SPI_CTRL_SCLK_CONTINUOUS(sclkType) (0u)
    #define GPS_UART_GET_SPI_CTRL_SSEL_POLARITY(polarity)   (0u)
#else
    #define GPS_UART_GET_SPI_CTRL_SCLK_CONTINUOUS(sclkType) ((0u != (sclkType)) ? \
                                                                    (GPS_UART_SPI_CTRL_SCLK_CONTINUOUS) : (0u))

    #define GPS_UART_GET_SPI_CTRL_SSEL_POLARITY(polarity)   (((uint32) (polarity) << \
                                                                     GPS_UART_SPI_CTRL_SSEL0_POLARITY_POS) & \
                                                                     GPS_UART_SPI_CTRL_SSEL_POLARITY_MASK)
#endif /* ((GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1) */

#define GPS_UART_GET_SPI_CTRL_SUB_MODE(mode)        (((uint32) (mode) << GPS_UART_SPI_CTRL_MODE_POS) & \
                                                                                 GPS_UART_SPI_CTRL_MODE_MASK)

#define GPS_UART_GET_SPI_CTRL_SLAVE_SELECT(select)  (((uint32) (select) << \
                                                                      GPS_UART_SPI_CTRL_SLAVE_SELECT_POS) & \
                                                                      GPS_UART_SPI_CTRL_SLAVE_SELECT_MASK)
...
/* GPS_UART_UART_CTRL */
#define GPS_UART_GET_UART_CTRL_MODE(mode)           (((uint32) (mode) << \
...
#define GPS_UART_GET_UART_RX_CTRL_BREAK_WIDTH(width)    (((uint32) ((uint32) (width) - 1u) << \
                                                                    GPS_UART_UART_RX_CTRL_BREAK_WIDTH_POS) & \
                                                                    GPS_UART_UART_RX_CTRL_BREAK_WIDTH_MASK)
...
/* GPS_UART_UART_FLOW_CTRL */
#if !(GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1)
    #define GPS_UART_GET_UART_FLOW_CTRL_TRIGGER_LEVEL(level)   ( (uint32) (level) & \
                                                                 GPS_UART_UART_FLOW_CTRL_TRIGGER_LEVEL_MASK)

    #define GPS_UART_GET_UART_FLOW_CTRL_RTS_POLARITY(polarity) ((0u != (polarity)) ? \
                                                                (GPS_UART_UART_FLOW_CTRL_RTS_POLARITY) : (0u))

    #define GPS_UART_GET_UART_FLOW_CTRL_CTS_POLARITY(polarity) ((0u != (polarity)) ? \
                                                                (GPS_UART_UART_FLOW_CTRL_CTS_POLARITY) : (0u))

    #define GPS_UART_GET_UART_FLOW_CTRL_CTS_ENABLE(ctsEn)      ((0u != (ctsEn)) ? \
                                                                (GPS_UART_UART_FLOW_CTRL_CTS_ENABLE) : (0u))
#endif /* !(GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1) */
...
#define GPS_UART_GET_RX_MATCH_MASK(mask)    (((uint32) (mask) << \
...
#define GPS_UART_GET_TX_CTRL_DATA_WIDTH(dataWidth)  (((uint32) (dataWidth) - 1u) & \
                                                                GPS_UART_TX_CTRL_DATA_WIDTH_MASK)
...
/* GPS_UART_INTR_SLAVE_I2C_GENERAL */
#define GPS_UART_GET_INTR_SLAVE_I2C_GENERAL(genCall)  ((0u != (genCall)) ? \
                                                                (GPS_UART_INTR_SLAVE_I2C_GENERAL) : (0u))

/* Return true if master mode is enabled GPS_UART_SPI_CTRL_REG */
#define GPS_UART_CHECK_SPI_MASTER   (0u != (GPS_UART_SPI_CTRL_REG & GPS_UART_SPI_CTRL_MASTER))

/* Return inactive state of SPI SCLK line depends on CPOL */
#define GPS_UART_GET_SPI_SCLK_INACTIVE \
            ((0u == (GPS_UART_SPI_CTRL_REG & GPS_UART_SPI_CTRL_CPOL)) ? (0u) : (1u))

/* Get output pin inactive state */
#if (GPS_UART_CY_SCBIP_V0 || GPS_UART_CY_SCBIP_V1)
#define GPS_UART_GET_SPI_SS0_INACTIVE       (1u)
#define GPS_UART_GET_SPI_SS1_INACTIVE       (1u)
#define GPS_UART_GET_SPI_SS2_INACTIVE       (1u)
#define GPS_UART_GET_SPI_SS3_INACTIVE       (1u)
#define GPS_UART_GET_UART_RTS_INACTIVE      (1u)

#else
#define GPS_UART_GET_SPI_SS0_INACTIVE  \
        ((0u != (GPS_UART_SPI_CTRL_REG & GPS_UART_SPI_CTRL_SSEL0_POLARITY)) ? (0u) : (1u))

#define GPS_UART_GET_SPI_SS1_INACTIVE  \
        ((0u != (GPS_UART_SPI_CTRL_REG & GPS_UART_SPI_CTRL_SSEL1_POLARITY)) ? (0u) : (1u))

#define GPS_UART_GET_SPI_SS2_INACTIVE  \
        ((0u != (GPS_UART_SPI_CTRL_REG & GPS_UART_SPI_CTRL_SSEL2_POLARITY)) ? (0u) : (1u))

#define GPS_UART_GET_SPI_SS3_INACTIVE  \
        ((0u != (GPS_UART_SPI_CTRL_REG & GPS_UART_SPI_CTRL_SSEL3_POLARITY)) ? (0u) : (1u))

#define GPS_UART_GET_UART_RTS_INACTIVE \
        ((0u == (GPS_UART_UART_FLOW_CTRL_REG & GPS_UART_UART_FLOW_CTRL_RTS_POLARITY)) ? (0u) : (1u))
...
#define GPS_UART_CY_SCBIP_V1_I2C_ONLY   (GPS_UART_CY_SCBIP_V1)
#define GPS_UART_EZBUFFER_SIZE          (GPS_UART_EZ_DATA_NR)

#define GPS_UART_EZBUF_DATA00_REG   GPS_UART_EZBUF_DATA0_REG
#define GPS_UART_EZBUF_DATA00_PTR   GPS_UART_EZBUF_DATA0_PTR
