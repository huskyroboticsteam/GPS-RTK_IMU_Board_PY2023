...
#define ID_IMU_READ_OPR_MODE        (uint8_t) 0x00
#define ID_IMU_WRITE_OPR_MODE       (uint8_t) 0x01
#define ID_IMU_SEND_OPR_MODE        (uint8_t) 0x02
#define ID_IMU_QUERY_CALIB_STAT     (uint8_t) 0x03
#define ID_IMU_SEND_CALIB_STAT      (uint8_t) 0x04
#define ID_IMU_READ_ACC_OFFSET      (uint8_t) 0x10
#define ID_IMU_READ_MAG_OFFSET      (uint8_t) 0x11
#define ID_IMU_READ_GYRO_OFFSET     (uint8_t) 0x12
#define ID_IMU_READ_RADIUS_OFFSET   (uint8_t) 0x13
#define ID_IMU_WRITE_ACC_OFFSET     (uint8_t) 0x14
#define ID_IMU_WRITE_MAG_OFFSET     (uint8_t) 0x15
#define ID_IMU_WRITE_GYRO_OFFSET    (uint8_t) 0x16
#define ID_IMU_WRITE_RADIUS_OFFSET  (uint8_t) 0x17
#define ID_IMU_SEND_ACC_OFFSET      (uint8_t) 0x18
#define ID_IMU_SEND_MAG_OFFSET      (uint8_t) 0x19
#define ID_IMU_SEND_GYRO_OFFSET     (uint8_t) 0x1A
#define ID_IMU_SEND_RADIUS_OFFSET   (uint8_t) 0x1B
