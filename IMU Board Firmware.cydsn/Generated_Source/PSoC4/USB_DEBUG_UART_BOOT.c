...
/*******************************************************************************
* Function Name: USB_DEBUG_UartCyBtldrCommStart
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: USB_DEBUG_UartCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: USB_DEBUG_UartCyBtldrCommReset
****************************************************************************//**
*
...
void USB_DEBUG_UartCyBtldrCommReset(void)
{
    ...
    USB_DEBUG_SpiUartClearRxBuffer();
    USB_DEBUG_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: USB_DEBUG_UartCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != USB_DEBUG_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = USB_DEBUG_SpiUartGetRxBufferSize();
                    CyDelayUs(USB_DEBUG_UART_BYTE_TO_BYTE);
                }
                while (byteCount != USB_DEBUG_SpiUartGetRxBufferSize());

                byteCount = USB_DEBUG_BYTES_TO_COPY(byteCount, size);
        ...
        {
            pData[i] = (uint8) USB_DEBUG_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: USB_DEBUG_UartCyBtldrCommWrite
****************************************************************************//**
*
...
cystatus USB_DEBUG_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        USB_DEBUG_SpiUartPutArray(pData, (uint32) size);
