/*
 *This code was stolen from the CAN github Portfiles examples.
 *If it's broken you know who to blame:
 *
 * Authors: Austin Chan
...
uint8_t getChipType()
{
    return 0x0000000; //This is supposed to be the CHIP_TYPE but Idk how that works so it's 0 now
}
